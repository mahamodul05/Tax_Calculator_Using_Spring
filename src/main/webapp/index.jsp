...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <p align="middle">
            <a class="btn btn-danger btn-lg" onclick="window.location.href='user/adminregistration'; return false;">ADMIN</a>
            <a class="btn btn-primary btn-lg" onclick="window.location.href='user/registration'; return false;">USER</a>
        </p>
    </div>
    <div class="col-md-2"></div>
</div>
