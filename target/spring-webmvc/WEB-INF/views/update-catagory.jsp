...
<form action="updatecatagory" method="post" novalidate>
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Update Catagory</h4>
                    </div>
                    <div class="row mt-1">
                        <div class="col-md-6"><label class="labels">General</label><input type="text" class="form-control"
                                                                                       name="general"
                                                                                       value="<%=catagory.getGeneral()%>" >
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">Female/Senior_citizen</label><input type="text" class="form-control"
                                                                                       name="female"
                                                                                       value="<%=catagory.getFemale()%>" >
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Disable</label><input type="text" name="disable"
                                                                                              class="form-control"
                                                                                              value="<%=catagory.getDisable()%>">
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-12"><label class="labels">Gazeted_Freedom_Fighter</label><input type="text" name="gazeted"
                                                                                           class="form-control"
                                                                                           value="<%=catagory.getGazeted()%>">
                        </div>
                    </div>

                        <input type="hidden" name="id"
                               class="form-control"
                               value="<%=catagory.getId()%>">



                        <div class="mt-5 text-center">
                            <button type="submit" class="btn btn-primary profile-button">Update Catagory</button>
                        </div>
